...
priors.out <- calcMoversPriors(geo.a = "CA", geo.b = "CA", year.start = 2014, year.end = 2015, 
                               var.prior.lambda = 0.0001, var.prior.pi = 0.1, L = 3, lambda.count = TRUE)
names(priors.out)
```
