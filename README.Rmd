...
- `across.geo`: TRUE/FALSE, indicating whether the function should look for list slots in `object` labelled `within.geo` (indicating a list of within-geography matches, such as California/2015 -> California/2016) and `across.geo` (indicating a list of across-geography matches, such as California/2015 -> New York/2016). Default is FALSE.
