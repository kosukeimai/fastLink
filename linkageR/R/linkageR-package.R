...
#' 
#' \tabular{ll}{ Package: \tab linkageR\cr Type: \tab Package\cr Version: \tab 0.1.-\cr
#' Date: \tab 2017-01-27\cr License: \tab GPL (>= 3)\cr }
#'
#' @name linkageR-package
#' @useDynLib linkageR
#' @aliases linkageR-package linkageR
#' @docType package
...
#' @keywords package
#' @import Matrix, parallel, foreach, doParallel, gtools, stringdist, data.table
